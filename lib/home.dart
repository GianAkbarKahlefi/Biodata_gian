...
import 'package:biodataa/tambah.dart';
import 'package:biodataa/models/model_siswa.dart';
...
class HomeState extends State<Home> {
  ...
  Future<List<SiswaModel>> getSwList() async {
    final response =
        await http.get(Uri.parse("http://10.2.4.12/biodata/list.php"));
          ...
          builder:
            ...
            return ListView.separated(
              ...
              separatorBuilder: (context, index) =>
                  Divider(height: 1, color: Colors.grey[300]), // Adds dividers
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => Detail(sw: data)));
                    },
                  ),
                );
              },
